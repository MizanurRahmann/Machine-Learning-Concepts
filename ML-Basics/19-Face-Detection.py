...
imagePath = "./Dataset/image.jpg"
cascadeClassifierPath = "./Dataset/haarcascade_frontalface_alt.xml"

cascadeClassifier = cv2.CascadeClassifier(cascadeClassifierPath)

# Read and convert image to grascale
...
# Detect faces
detectedFaces = cascadeClassifier.detectMultiScale(grayScaleImage,  scaleFactor=1.1, minNeighbors=10, minSize=(30, 30))

# Draw reactangle on faces
for(x,y, width, height) in detectedFaces:
	cv2.rectangle(image, (x, y), (x+width, y+height), (0,0,255), 10)

# Print the result	
cv2.imwrite('./Dataset/result.jpg', image)